...
export default function Register() {
  ...
  return (
    <>
      <div>
        <div
          className="flex flex-col md:flex-row flex-wrap items-center justify-between p-4 sm:mx-auto max-w-screen-xl md:mt-20">
          ...
          <div className="md:w-1/2 w-full ">
            <h1 className=" text-4xl font-bold text-center mb-5 text-red-600">Inscription</h1>
            {/* Form of login */}
            <form>
              {/*Input Name*/}
              <input
                className="text-sm w-full px-4 py-4 border border-gray-300 rounded-lg my-5"
                type="text"
                value={name}
