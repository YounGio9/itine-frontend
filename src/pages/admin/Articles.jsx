...
import vêtements_homme from "../../assets/vêtements_homme.png"
import vêtements_homme1 from "../../assets/vêtements_homme1.png"
              ...
              <div id="tab1" className={`tab-content ${activeTab === 'tab1' ? '' : 'hidden'}`}>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
                  <div class="bg-gray-100 p-4 rounded-lg shadow-md relative">
                    ...
                    <img src={vêtements_homme} alt="vêtements_homme" />
                  </div>
                ...
                <div>
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
                    <div class="bg-gray-100 p-4 rounded-lg shadow-md relative">
                      ...
                      <img src={vêtements_homme1} alt="vêtements_homme" />
                    </div>
