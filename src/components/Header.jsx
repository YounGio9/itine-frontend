...
function Header({ fullName, email, photo }) {
        ...
        <div className=" mr-5 mt-3 float-right">
          {isActiveMenu && (
            <div className="absolute top-14 right-2 text-black bg-white rounded-lg p-2">
              ...
              <Link
                to="/settings"
                className="hover:bg-[#DC3545] mx-2 bg-[#F0F0F0] flex dash_link p-2 rounded-md my-2 md:mt-0"
              >
                <svg
              ...
              <div
                role="menuitem"
                className="hover:bg-[#DC3545] mx-2 bg-[#F0F0F0] flex dash_link p-2 rounded-md my-2 md:mt-2"
