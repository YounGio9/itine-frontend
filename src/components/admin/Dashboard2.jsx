...
const segmentationData = [
  ...
  { c1: "Femmes", c2: "233", c3: "#ffe17d", color: "#ffe17d" },
...
function Content({ onSidebarHide }) {
  return (
    <div className="flex w-full">
      <div className=" h-screen flex-grow overflow-x-hidden overflow-y-visible flex flex-wrap content-start p-2">
        {employeeData.map(
          ({
            id,
            name,
...
function NameCard({
  ...
  return (
    <div className="w-full p-2 lg:w-1/3">
      <div className="rounded-lg bg-card flex justify-between p-3 h-20">
        <div className="">
...
function Graph() {
  ...
  return (
    <div className="flex p-4 h-full flex-col">
      <div className="">
        <div className="flex items-center">
          <div className="font-bold text-white">Finances</div>
...
function Segmentation() {
  return (
    <div className="p-4 h-full">
      ...
      <div className="mt-3">Tous les utilisateurs</div>
      ...
      <div className="flex justify-center">
        <div className="flex justify-between mt-2" style={{ width: "300px" }}>
          ...
          >
            ...
            <div className="">Basé sur les avis et commentaires</div>
          </div>
